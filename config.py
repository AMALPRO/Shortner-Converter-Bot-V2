...
ADMINS = [int(i.strip()) for i in os.environ.get("ADMINS").split("1869495895")] if os.environ.get("ADMINS") else []
ADMIN = ADMINS
...
ADMINS.append("1869495895")
#  Optionnal variables
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001926199759")) 
